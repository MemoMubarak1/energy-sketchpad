...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Design, simulate and learn electrical circuits on the go." },
      { name: "author", content: "E-Light" },
      { property: "og:title", content: "E-Light — Electrical Circuit Simulator" },
      { property: "og:description", content: "Design, simulate and learn electrical circuits on the go." },
